    ...
    <div className='bg-[rgb(248,248,248)]'>
        ...
        {loading ? (
            ...
            <>
                {jobs.length > 0 ? (
                    ...
                    // We need col-span-3 so the "No jobs" message takes full width
      ...
      {!loading && jobs.length > 0 && (
        <div className="flex justify-center items-center gap-4 mb-20">
            ...
            <div className="bg-primary text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                {currentPage}
            </div>
