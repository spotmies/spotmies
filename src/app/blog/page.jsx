        ...
        <Navbarr noScrollEffect={true} career={true} />
            ...
            <div className='bg-[#ebeaea] px-16 py-16'>
                ...
                <div className='flex gap-10 w-fit mx-auto '>
                   <Link href="/blog/blogs"><img className='h-[50vh] rounded-3xl mt-10' src="https://images.pexels.com/photos/1051073/pexels-photo-1051073.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" /> </Link>
                   <Link href="/blog/blogs"><img className='h-[50vh] rounded-3xl mt-10' src="https://images.pexels.com/photos/1051073/pexels-photo-1051073.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" /> </Link>
                   <Link href="/blog/blogs"><img className='h-[50vh] rounded-3xl mt-10' src="https://images.pexels.com/photos/1051073/pexels-photo-1051073.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" /> </Link>
                   <Link href="/blog/blogs"><img className='h-[50vh] rounded-3xl mt-10' src="https://images.pexels.com/photos/1051073/pexels-photo-1051073.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" /> </Link>
                </div>
